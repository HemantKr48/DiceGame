...
const dicenum = ["dice-1.png", "dice-2.png", "dice-3.png", "dice-4.png", "dice-5.png", "dice-6.png"];
...
rolldicebtn.addEventListener("click", function () {
  ...
  const afterrolldice = document.querySelector(".after_rolldice");
  const imageElement = document.createElement("img");
  if (currentImage) {
    afterrolldice.removeChild(currentImage);
  }
  ...
  if (randomNumber1 === 1) {
    if (randomNumber === 1) {
      ...
      score1 = 0;
      imageElement.src = dicenum[0];
    } else {
        
      score1 += randomNumber;
      player1win();
      firstPlayerCurrentScore.textContent = score1;
      imageElement.src = dicenum[randomNumber - 1];
    }
    afterrolldice.appendChild(imageElement);
  } else {
    if (randomNumber === 1) {
